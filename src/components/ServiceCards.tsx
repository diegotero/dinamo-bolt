      ...
      return (
        <section className="container mx-auto py-16">
          <div className="max-w-5xl mx-auto text-center mb-12 px-4">
            ...
            <p className="text-lg md:text-xl text-gray-600" style={{ color: colors.textGray }}>
            ...
            {serviceCards.map((card, index) => (
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg md:text-xl font-semibold text-gray-900" style={{ color: colors.textGray }}>
                    {card.title}
                  </h3>
                </div>
